            ...
            <ul>
                ...
                <li class="submenu active">
                    ...
                    <?php if ($user['role_id'] == '2') { ?>
                        <a href="<?php echo base_url('petugas') ?>"><i class="feather-grid"></i> <span> Dashboard</span></a>
                    <?php } ?>
                </li>
                <li class="menu-title">
                ...
                <?php if ($user['role_id'] == '2') { ?>
                    <li>
                        <a href="<?php echo base_url('petugas/buku') ?>"><i class="fas fa-book"></i> <span>Kelola Buku Perpustakaan</span></a>
                    </li>
                <?php } ?>
            </ul>
        </div>
