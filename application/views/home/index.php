        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Dinas Kearsipan Dan Perpustakaan Daerah Kabupaten Purwakarta</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Membangun Budaya Baca di Seluruh Lapisan Masyarakat Kabupaten Purwakarta</h2>
                    <div data-aos="fade-up" data-aos-delay="600">
                        <div class="text-center text-lg-start">
                            <a href="<?php echo base_url('home/tamu') ?>" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                ...
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="<?php echo base_url('assets/home') ?>/img/hero-img.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Address</h3>
                                    <p>Jalan Mr. Dr. Kusumahatmaja No. 8</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-info">
                        ...
                        <p>Membangun Budaya Baca di Seluruh Lapisan Masyarakat Kabupaten Purwakarta.</p>
